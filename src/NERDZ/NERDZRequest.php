 ...
 * NERDZ.
 *
 * As with any software that integrates with the NERDZ platform, your use
 * of this software is subject to the NERDZ Developer Principles and
 * Policies [http://developers.NERDZ.com/policy/]. This copyright notice
...
class NERDZRequest
{
    ...
    public function getUrl()
    {
        ...
        $graphVersion = NERDZUrlManipulator::forceSlashPrefix($this->graphVersion);
    ...
    {
        return [
            'User-Agent' => 'fb-php-' . NERDZ::VERSION,
            'Accept-Encoding' => '*',
        ];
    }
}
